...
6)which 5 products have the highest percentage of percentage of purchases with discounts applied?
...
8)what are the top 3 most purchased products with in the  each category?
with item_counts as (
select category,
item_purchased,
